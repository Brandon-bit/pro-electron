...
import { createProcessLevel1Schema } from '@procesos/ProcesosDeNegocio/CadenasDeValor/validations/valueChainValidation'
import type { Level1ProcessType } from '@procesos/ProcesosDeNegocio/CadenasDeValor/types/valueChainType'

const props = defineProps<{
    isOpen: boolean
    process?: Level1ProcessType | null
    mode: 'create' | 'edit'
}>()
...
const { handleSubmit, resetForm, setValues } = useForm({
    validationSchema: toTypedSchema(createProcessLevel1Schema),
    initialValues: {
        title: ''
    }
})
