...
export type ProductoACResponse = {
    id?: number
    nombre?: string
}

export type ProductoACResponseDTO = {
    id?: number
    name?: string
}
...
export type TipomovimientoResponse = {
    id?: number
    nombre?: string
}

export type TipomovimientoResponseDTO = {
    id?: number
    name?: string
}