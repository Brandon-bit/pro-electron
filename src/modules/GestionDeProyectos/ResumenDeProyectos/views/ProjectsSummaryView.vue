...
import StageTracker from '@/modules/GestionDeProyectos/ResumenDeProyectos/components/StageTracker.vue'
import useSummaryStore from '@/modules/GestionDeProyectos/ResumenDeProyectos/store/summaryStore'
import { useSummaryActions } from '@/modules/GestionDeProyectos/ResumenDeProyectos/composables/useSummaryActions'
