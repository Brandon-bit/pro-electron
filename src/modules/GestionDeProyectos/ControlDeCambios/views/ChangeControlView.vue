...
import ChangeRequestModal from '@/modules/GestionDeProyectos/ControlDeCambios/components/ChangeRequestModal.vue'
import KanbanBoard from '@/modules/GestionDeProyectos/ControlDeCambios/components/KanbanBoard.vue'
import StatsCards from '@/modules/GestionDeProyectos/ControlDeCambios/components/StatsCards.vue'
