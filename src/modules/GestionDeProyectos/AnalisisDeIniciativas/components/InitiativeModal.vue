...
import DeleteInitiative from '@/modules/GestionDeProyectos/AnalisisDeIniciativas/components/DeleteInitiative.vue'
import AddEditForm from '@/modules/GestionDeProyectos/AnalisisDeIniciativas/components/AddEditForm.vue'
import { useModalStore } from '@/shared/stores/modal.store'
import { initiativeSchema } from '@/modules/GestionDeProyectos/AnalisisDeIniciativas/validations/initiativeValidation'
