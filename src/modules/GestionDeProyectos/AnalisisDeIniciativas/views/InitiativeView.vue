...
import ConfigurationTab from '@/modules/GestionDeProyectos/AnalisisDeIniciativas/components/ConfigurationTab.vue'
import EvaluationTab from '@/modules/GestionDeProyectos/AnalisisDeIniciativas/components/EvaluationTab.vue'
import InitiativeModal from '@/modules/GestionDeProyectos/AnalisisDeIniciativas/components/InitiativeModal.vue'
import { useInitiativeActions } from '@/modules/GestionDeProyectos/AnalisisDeIniciativas/composables/useInitiativeActions'
import type { InitiativeType } from '@/modules/GestionDeProyectos/AnalisisDeIniciativas/types/initiativeTypes'
