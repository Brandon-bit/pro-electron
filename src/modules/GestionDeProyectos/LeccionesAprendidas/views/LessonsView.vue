...
import CreateLessonModal from '@/modules/GestionDeProyectos/LeccionesAprendidas/components/CreateLessonModal.vue'
import SearchBar from '@/modules/GestionDeProyectos/LeccionesAprendidas/components/SearchBar.vue'
import TrendsAnalysis from '@/modules/GestionDeProyectos/LeccionesAprendidas/components/TrendsAnalysis.vue'
import useLessonStore from '@/modules/GestionDeProyectos/LeccionesAprendidas/store/lessonStore'
import { useLessonActions } from '@/modules/GestionDeProyectos/LeccionesAprendidas/composables/useLessonActions'
