...
import EditorTab from '@/modules/GestionDeProyectos/SOWDelProyecto/components/EditorTab.vue'
import LibraryTab from '@/modules/GestionDeProyectos/SOWDelProyecto/components/LibraryTab.vue'
