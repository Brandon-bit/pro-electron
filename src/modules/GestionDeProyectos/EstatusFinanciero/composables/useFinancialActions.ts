...
import type { ProjectDetailType, GlobalSummaryType } from '@/modules/GestionDeProyectos/EstatusFinanciero/types/financialStatusTypes'
import useFinancialStatusStore from '@/modules/GestionDeProyectos/EstatusFinanciero/store/financialStatusStore'
