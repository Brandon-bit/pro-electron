...
import ProjectSelector from '@/modules/GestionDeProyectos/Operacion/CasoDeNegocio/components/ProjectSelector.vue'
import KPICards from '@/modules/GestionDeProyectos/Operacion/CasoDeNegocio/components/KPICards.vue'
import useBusinessCaseStore from '@/modules/GestionDeProyectos/Operacion/CasoDeNegocio/store/businessCaseStore'
import { useBusinessCalculations } from '@/modules/GestionDeProyectos/Operacion/CasoDeNegocio/composables/useBusinessCalculations'
import { useBusinessActions } from '@/modules/GestionDeProyectos/Operacion/CasoDeNegocio/composables/useBusinessActions'
