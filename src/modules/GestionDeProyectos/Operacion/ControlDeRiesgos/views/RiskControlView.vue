...
import RiskModal from '@/modules/GestionDeProyectos/Operacion/ControlDeRiesgos/components/RiskModal.vue'
import RiskHeatmap from '@/modules/GestionDeProyectos/Operacion/ControlDeRiesgos/components/RiskHeatmap.vue'
import ControlHeatmap from '@/modules/GestionDeProyectos/Operacion/ControlDeRiesgos/components/ControlHeatmap.vue'
import DashboardCards from '@/modules/GestionDeProyectos/Operacion/ControlDeRiesgos/components/DashboardCards.vue'
import useRiskStore from '@/modules/GestionDeProyectos/Operacion/ControlDeRiesgos/store/riskStore'
import { useRiskActions } from '@/modules/GestionDeProyectos/Operacion/ControlDeRiesgos/composables/useRiskActions'
