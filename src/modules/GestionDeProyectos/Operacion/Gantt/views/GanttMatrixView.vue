...
import StatusLegend from '@/modules/GestionDeProyectos/Operacion/Gantt/components/StatusLegend.vue'
import { useGanttActions } from '@/modules/GestionDeProyectos/Operacion/Gantt/composables/useGanttActions'
import useGanttTable from '@/modules/GestionDeProyectos/Operacion/Gantt/composables/useGanttTable'
