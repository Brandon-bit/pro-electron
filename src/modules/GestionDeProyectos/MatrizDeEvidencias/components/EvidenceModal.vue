...
import type { ProjectEvidenceType, EvidenceType } from '@/modules/GestionDeProyectos/MatrizDeEvidencias/types/evidenceTypes'
import BaseModal from '@/shared/components/BaseModal.vue'
import BaseTable from '@/shared/components/BaseTable.vue'
import { useModalStore } from '@/shared/stores/modal.store'
import { useEvidenceModalTable } from '@/modules/GestionDeProyectos/MatrizDeEvidencias/composables/useEvidenceModalTable'
