...
export const mapEmployee = (data: Employee): EmployeeDTO => ({
    ...
    employeeDocuments: data.documentosEmpleado,
    psychometricTests: data.pruebasPsicometricas
})
...
export const mapEmployeeRequest = (data: EmployeeRequest): EmployeeRequestPayload => ({
    ...
    documentosEmpleado: data.employeeDocuments,
    pruebasPsicometricas: data.psychometricTests
})
