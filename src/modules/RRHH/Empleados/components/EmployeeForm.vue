...
const banks = ref<SelectOptionDTO[]>([])
...
onMounted(async () => {
    ...
    // Load banks
    banks.value = await getBanksForSelect()
...
watch(
    ...
    async (selectedCompany) => {
        ...
        // Convert to number if it's a string
        const companyId =
            typeof selectedCompany === 'string' ? parseInt(selectedCompany) : selectedCompany
    ...
    <div>
        ...
        <div class="lg:max-w-[70%] lg:mx-auto">
            <form @submit="onSubmit">
                ...
                <!-- COLLAPSE DATOS BANCARIOS -->
                <div class="collapse collapse-arrow bg-base-100 mb-5 border border-base-300">
                    <input type="checkbox" name="employee-bank-data" checked />
                    <div class="collapse-title border-b-1 border-base-300 mb-6 !font-bold">
                        Datos Bancarios
                    </div>
                    <div class="collapse-content text-sm">
                        <div class="grid grid-cols-12 gap-5">
                            ...
                            <div class="col-span-12">
                                <div class="alert alert-info">
                                    ...
                                    <span class="text-sm"
                                        >La CLABE interbancaria debe tener 18 dígitos. Esta
                                        información será utilizada para el pago de nómina.</span
                                    >
                                </div>
                            </div>
                        </div>
                ...
                <!-- COLLAPSE PRUEBAS PSICOMÉTRICAS -->
                <div class="collapse collapse-arrow bg-base-100 mb-5 border border-base-300">
                    <input type="checkbox" name="employee-psychometric-tests" checked />
                    <div class="collapse-title border-b-1 border-base-300 mb-6 !font-bold">
                        Pruebas Psicométricas
                    </div>
                    <div class="collapse-content text-sm">
                        <div class="grid grid-cols-12 gap-5">
                            <!-- Psychometric Tests Upload -->
                            <BaseFormInputFile
                                class="col-span-12"
                                name="psychometricTests"
                                label="Pruebas psicométricas (PDF)"
                                :multiple="true"
                                accept=".pdf"
                            />
                        </div>
