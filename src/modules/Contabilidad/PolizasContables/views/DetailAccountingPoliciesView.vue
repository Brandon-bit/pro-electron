...
// Botón Editar
const handleEdit = () => {
    accountingPoliciesStore.setData(policy.value) // carga la póliza seleccionada
    accountingPoliciesStore.setEditMode(true)    // activa modo edición
    router.push('/contabilidad/crear-poliza-contable') // navega a la vista de creación
}

// Botón Volver
const goBack = () => router.push('/contabilidad/polizas-contables')
</script>
