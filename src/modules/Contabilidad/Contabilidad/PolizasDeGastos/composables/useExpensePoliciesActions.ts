import type { ExpensePolicyType, ExpensePolicyFormType, SupplierInvoiceType } from '@/modules/Contabilidad/Contabilidad/PolizasDeGastos/types/expensePoliciesTypes'
