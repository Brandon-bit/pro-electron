...
import FixedAssetForm from '@/modules/Contabilidad/Contabilidad/ActivosFijos/components/FixedAssetForm.vue'
...
const onSubmit = handleSubmit(async (formValues) => {
    ...
    const modalType = modalStore.modals[fixedAssetsStore.modalId]?.type as 'CREATE' | 'UPDATE' | 'VIEW'
