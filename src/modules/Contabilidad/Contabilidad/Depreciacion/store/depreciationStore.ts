...
import type { DepreciableAssetType, DepreciationMethodType } from '@/modules/Contabilidad/Contabilidad/Depreciacion/types/depreciationTypes'

const useDepreciationStore = defineStore('depreciation-store', {
    state: () => ({
        selectedMonth: '03',
        selectedYear: '2024',
        depreciationMethod: 'depreciacion-fiscal' as DepreciationMethodType,
