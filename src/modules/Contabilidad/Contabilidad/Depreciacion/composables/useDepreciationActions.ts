import type { DepreciableAssetType, SelectOptionDTO } from '@/modules/Contabilidad/Contabilidad/Depreciacion/types/depreciationTypes'

// Mock data - Month Options
const mockMonthOptions: SelectOptionDTO[] = [
    { id: '01', label: 'Enero' },
    { id: '02', label: 'Febrero' },
    { id: '03', label: 'Marzo' },
    { id: '04', label: 'Abril' },
...
// Mock data - Year Options
const mockYearOptions: SelectOptionDTO[] = [
    { id: '2024', label: '2024' },
    { id: '2023', label: '2023' },
    { id: '2022', label: '2022' }
]

// Mock data - Method Options
const mockMethodOptions: SelectOptionDTO[] = [
    { id: 'linea-recta', label: 'Línea Recta' },
    { id: 'depreciacion-fiscal', label: 'Depreciación Fiscal' },
...
export const useDepreciationActions = () => {
    ...
    /**
     * Obtiene las opciones de meses
     */
    const getMonthOptions = () => {
        return mockMonthOptions
    }

    /**
     * Obtiene las opciones de años
     */
    ...
    /**
     * Obtiene las opciones de métodos de depreciación
     */
