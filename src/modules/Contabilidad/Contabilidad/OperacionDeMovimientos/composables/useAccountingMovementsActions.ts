import type { AccountingMovementType, SearchFiltersType, SelectOptionDTO } from '@/modules/Contabilidad/Contabilidad/OperacionDeMovimientos/types/accountingMovementsTypes'

// Mock data - Cost Center Options
const mockCostCenterOptions: SelectOptionDTO[] = [
...
export const useAccountingMovementsActions = () => {
    ...
    /**
     * Obtiene las opciones de centros de costo
     */
    const getCostCenterOptions = () => {
        return mockCostCenterOptions
    }
