import type { JournalEntryType, JournalBookFiltersType, JournalBookSummaryType } from '@/modules/Contabilidad/Contabilidad/LibrosDeDiario/types/journalBooksTypes'
