...
import JournalPolicyModal from '@/modules/Contabilidad/Contabilidad/PolizasDeDiario/components/JournalPolicyModal.vue'
import useJournalPolicies from '@/modules/Contabilidad/Contabilidad/PolizasDeDiario/composables/useJournalPolicies'
