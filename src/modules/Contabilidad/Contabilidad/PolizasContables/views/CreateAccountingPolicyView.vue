...
import type { AccountingEntryDTO } from '@/modules/Contabilidad/Contabilidad/PolizasContables/types/accountingPoliciesTypes'

const router = useRouter()
const { getAccountingPolicyTypes, createAccountingPolicy } = useAccountingPoliciesActions()
...
const onSubmit = handleSubmit(async (formValues) => {
    try {
        ...
        const result = await createAccountingPolicy(completeFormData)
        ...
        showNotification('Error al crear la póliza', 'error')
    }
})
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <BaseTitle 
                ...
                subtitle="Registra una nueva póliza contable en el sistema"
            />
