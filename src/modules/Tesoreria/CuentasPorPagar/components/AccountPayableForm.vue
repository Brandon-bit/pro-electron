...
const supplierOptions = ref<selectOptions[]>([])
...
onMounted(async () => {
    supplierOptions.value = await getSuppliersForSelect()
})
</script>
...
<template>
    <div class="grid grid-cols-12 gap-3">
        <div class="col-span-6">
            <BaseFormSelect name="supplierId" label="Proveedor" :options="supplierOptions" :required="true" />
        </div>
        ...
        <div class="col-span-12">
            <BaseTextArea name="notes" label="Notas" placeholder="Observaciones sobre la cuenta por pagar" />
        </div>
    </div>
</template>
