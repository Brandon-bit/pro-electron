...
import { saveTokenToStorage, removeTokenFromStorage, getTokenFromStorage, getUserFromToken, isTokenValid } from '@/utils/jwtUtils';
/**
...
class AuthService {
    ...
    async validateToken() {
        try {
            ...
            const response = await axiosApiInstance.get('/auth/validate');
