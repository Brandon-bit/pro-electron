...
//dashboard
    ...
    {
        path: '/marketing/integraciones',
        name: 'Integraciones',
        component: () =>
            import('@marketing/CordinadorRedesSociales/views/IntegrationsView.vue')
    },
    {
        path: '/sendible/callback',
        name: 'SendibleCallback',
        component: () =>
            import('@marketing/CordinadorRedesSociales/views/SendibleCallback.vue')
    },
